            ...
            <div className="SectionHero-Overlay">
                <div className="SectionHero-Content">
                    ...
                    <p className="SectionHero-Subheading">
                        ...
                        Svojim aktivnostima pomaže im kako bi se uspješno nosili s akademskim izazovima, napredovali kroz studij i počeli graditi svoju karijeru već tijekom studentskih dana.</p>
                </div>
            </div>
        </section>
    );
